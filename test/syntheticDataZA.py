from callBloch import bloch_parse, bloch_run, updateSymUgh, LARBED
...
param = bloch_parse(fname='examples/Si_undoped/si110.dat')
...
param = bloch_run(param, ncores=8)
cbed = LARBED(param, 384, )
...
# plt.imshow(np.rot90(canvas, k=3), cmap='inferno', vmax=0.4)
# plt.show()
...
np.save('box/syntheticData/Si110/cbed.npy', cbed)
np.save('box/syntheticData/Si110/noisy1e5_cbed.npy', noisy_cbed)
np.save('box/syntheticData/Si110/indices.npy', param.hklout.T)
